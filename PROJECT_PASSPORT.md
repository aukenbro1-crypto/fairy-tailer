...
- Dynamic content should replace template placeholders only: cover title, cover subtitle/summary, cover art, front matter, chapter title pages, full-page chapter illustrations, five text pages per chapter, and the final QR/coauthor page. Do not add extra colored rectangles or duplicate `by FairyTeller` outside the PPTX page plan.
