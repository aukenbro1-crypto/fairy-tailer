...
const commonFaq = [
  ...
  ["Как создается история?", "Историю и иллюстрации создает искусственный интеллект, время генерации макета занимает около трех минут. Перед печатью тексты вычитывает команда опытных редакторов."],
...
const pages = [
  ...
  },
  {
    ...
    fallback: `
      <main>
        ...
        <h2>Повод для необычного подарка</h2>
        <ul>
  ...
  },
  {
    ...
    description:
      "Персональная книга жене на день рождения: она главная героиня, сюжет про неё, иллюстрации по фото. От 3500₽, доставка по России от 2 дней.",
    type: "product",
    jsonLd: [
      productJsonLd("Подарок жене на день рождения от мужа — книга о ней", "Персональная книга жене на день рождения: она главная героиня, сюжет про нее, иллюстрации по фото. От 3500₽, доставка по России от 2 дней.", "/podarok/zhene"),
      faqJsonLd([
        ["Это подойдет как подарок жене на день рождения?", "Да. Страница собрана именно под подарок жене на день рождения от мужа: книга получается личной, с ее именем, характером, фото и деталями вашей жизни вместе."],
        ["Можно сделать книгу только про нее?", "Да. Жена может быть главной героиней, а муж, семья, город, путешествие или важное воспоминание станут частью сюжета."],
      ...
      breadcrumbJsonLd([
        ["Главная", "/"],
        ["Подарок жене", "/podarok/zhene"],
      ]),
    ],
    fallback: `
      <main>
        <h1>Подарок жене на день рождения: книга, в которой она главная героиня</h1>
        <p>Персональная книга с ее именем, характером, фото и деталями которые знаете только вы. От 3500₽.</p>
        <p>В книге 40 страниц и 5 иллюстрированных глав. Доставка по России - от 2 дней.</p>
        <h2>Не вещь</h2>
        <p>Книга о жене - это история написанная под нее одну: с ее именем, характером и деталями из вашей жизни вместе.</p>
        <p><a href="/create">Создать книгу жене</a></p>
      </main>`,
  },
  {
    path: "/podarok/mame",
    title: "Подарок маме на день рождения — книга о ней | Fairyteller",
    description:
      "Персональная книга маме на день рождения: она главная героиня, сюжет про её жизнь, иллюстрации по фото. От 3500₽, доставка по России от 2 дней.",
    type: "product",
    jsonLd: [
      productJsonLd("Подарок маме на день рождения — книга о ней", "Персональная книга маме на день рождения: она главная героиня, сюжет про ее жизнь, иллюстрации по фото. От 3500₽, доставка по России от 2 дней.", "/podarok/mame"),
      faqJsonLd([
        ["Это подойдет как подарок маме на день рождения?", "Да. Книга получается личной: с ее именем, характером, фото и деталями, которые знаете только вы."],
        ["Можно сделать книгу только про маму?", "Да. Мама может быть главной героиней, а семья, город, путешествие или важное воспоминание станут частью сюжета."],
        ["Насколько героиня будет похожа на фото?", "Фото помогает сохранить узнаваемые черты, прическу, образ и настроение. Это художественная иллюстрация, а не фотокопия."],
      ...
      breadcrumbJsonLd([
        ["Главная", "/"],
        ["Подарок маме", "/podarok/mame"],
      ]),
    ],
    fallback: `
      <main>
        <h1>Подарок маме на день рождения: книга, в которой она главная героиня</h1>
        <p>Персональная книга с ее именем, характером и историей жизни. От 3500₽.</p>
        <p>В книге 40 страниц и 5 иллюстрированных глав. Доставка по России - от 2 дней.</p>
        <h2>Не очередной сувенир</h2>
        <p>Книга о маме - это история написанная под нее одну: с ее именем, характером и деталями, которые знаете только вы.</p>
        <p><a href="/create">Создать книгу маме</a></p>
      </main>`,
  },
  {
  ...
  },
  {
    ...
    description:
      "Создайте персональную сказку по фото для ребёнка, пары, друга или близкого: узнаваемый герой, сюжет, иллюстрации, печать от 3500₽ и бесплатная доставка по России.",
    type: "product",
    jsonLd: [
      productJsonLd("Персональная сказка по фото — бумажная книга на заказ", "Создайте персональную сказку по фото для ребёнка, пары, друга или близкого: узнаваемый герой, сюжет, иллюстрации, редактура, печать и бесплатная доставка по России.", "/podarok/skazka-po-foto"),
      faqJsonLd([
        ...
        ["Для кого подойдут эти истории?", "Для детей, взрослых, пар, друзей, родителей и коллег. Формат адаптируется под героя: это может быть сказка, приключение, романтическая история, шутливый подарок или семейная книга."],
        ["Что значит бумажная книга?", "Fairyteller печатает небольшие бумажные книги. Сейчас доступна версия в мягком переплёте 13 × 13 см: 5 глав, около 40 страниц и отдельные иллюстрации к сюжету."],
        ["Как создается история?", "Историю и иллюстрации создает искусственный интеллект, время генерации макета занимает около трех минут. Перед печатью тексты вычитывает команда опытных редакторов."],
        ["Сколько стоит и как быстро делается?", "Печатная книга стоит от 3500₽. Первое превью появляется за несколько минут, после оплаты команда Fairyteller вычитывает текст, собирает макет и передаёт книгу в печать."],
        deliveryFaq,
      ]),
      breadcrumbJsonLd([
        ["Главная", "/"],
    ...
    fallback: `
      <main>
        <h1>Персональная сказка по фото: станьте героем книги</h1>
        <p>Создайте историю по фото: узнайте себя и своих близких в сюжете, иллюстрациях и деталях.</p>
        <p>Это стильная бумажная книга на заказ, где главные герои - вы, ваши близкие, дети, друзья, коллеги или питомцы.</p>
        <p>Fairyteller делает персональные сказки по фото от 3500₽ с редактурой, печатью и бесплатной доставкой по России.</p>
        <h2>Для каких поводов</h2>
        <ul>
          <li>день рождения ребёнка, друга или близкого</li>
          <li>Новый год, выпускной или семейный праздник</li>
          <li>шутливый подарок коллеге или другу</li>
          <li>тёплая книга для родителей, бабушки или дедушки</li>
        </ul>
        <h2>Что можно добавить</h2>
        <ul>
          <li>чёткое фото лица и комплекции героя</li>
          <li>имя, возраст и характер героев</li>
          <li>любимое место или мир истории</li>
          <li>стиль иллюстраций</li>
          <li>игрушку, питомца, талисман или важную деталь</li>
        </ul>
        <ol>
          <li>выберите жанр</li>
          <li>добавьте фото и детали героя</li>
          <li>получите превью персональной сказки</li>
          <li>закажите печатную книгу с доставкой</li>
        </ol>
        <p>Если вы хотите создать персонализированную сказку, но ищете подарок, который можно держать в руках, бумажная книга лучше сохраняет память, чем одноразовая картинка или PDF.</p>
