...
const pages = [
  ...
  },
  {
    ...
    description:
      "Создайте книгу с вашими именами, фото, знаковыми местами, общими шутками и воспоминаниями. От 3500₽, 40 страниц и 5 иллюстрированных глав.",
    type: "product",
    jsonLd: [
    ...
    fallback: `
      <main>
        <h1>Подарок для пары: персональная книга с вашей историей</h1>
        <p>Создайте книгу с вашими именами, фото, знаковыми местами, общими шутками и воспоминаниями. От 3500₽.</p>
