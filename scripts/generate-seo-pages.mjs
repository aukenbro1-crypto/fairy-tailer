...
const pages = [
  ...
  },
  {
    ...
    description:
      "Ищете подарок ребенку? Создайте персональную бумажную книгу, где ребенок становится главным героем. Фото, имя, любимые детали, печать от 3500₽ и доставка по России.",
    type: "product",
    jsonLd: [
      productJsonLd("Подарок ребенку: персональная бумажная книга", "Необычный подарок ребенку: персональная бумажная книга, где ребенок становится главным героем истории с иллюстрациями по фото.", "/podarok/rebenku"),
      faqJsonLd([
      ...
      breadcrumbJsonLd([
        ["Главная", "/"],
        ["Подарок ребенку", "/podarok/rebenku"],
      ]),
    ],
    fallback: `
      <main>
        <h1>Подарок ребенку, где он сам становится героем</h1>
        <p>Если вы думаете, что подарить ребенку, персональная бумажная книга помогает уйти от обычной игрушки, сладостей или очередной вещи.</p>
        <p>Это необычный подарок ребенку: история создается по фото, имени, характеру, любимым деталям и поводу. Ребенок узнает себя в книге и становится главным героем.</p>
        <p>Fairyteller делает физическую печатную книгу от 3500₽ с иллюстрациями, редактурой и доставкой по России.</p>
        <h2>Почему книга</h2>
        <ul>
          ...
          <li>подходит на день рождения, Новый год, выпускной или без повода</li>
        </ul>
        <h2>Что можно добавить</h2>
        <ul>
          <li>фото ребенка</li>
        ...
        <p><a href="/podarok/rebenku">Создать подарок ребенку</a></p>
      </main>`,
  },
  {
