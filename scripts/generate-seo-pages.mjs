...
const pages = [
  ...
  },
  {
    ...
    description:
      "Загрузите фото ребёнка — получите сказку где он главный герой. Иллюстрации с узнаваемыми чертами, редактура, печатная книга от 3500₽ с доставкой по России.",
    type: "product",
    jsonLd: [
      productJsonLd("Создать сказку по фото — книга с иллюстрациями", "Сказка по фотографии ребёнка: персональная бумажная книга с иллюстрациями, редактурой и доставкой по России.", "/podarok/skazka-po-foto"),
      faqJsonLd([
        ["Насколько похож герой на фото?", "Мы стремимся сохранить узнаваемые черты: причёску, форму лица, общее выражение, одежду или важные детали. Это художественная иллюстрация в стиле книги."],
        ["Это только для детей?", "Нет. Чаще всего такую книгу заказывают детям, но можно создать сказку по фото для взрослого, пары или семьи."],
        ["Сколько делается?", "Первое превью появляется за несколько минут. Печатная книга после оплаты готовится к печати за один день и отправляется доставкой по России."],
      ]),
      breadcrumbJsonLd([
        ["Главная", "/"],
    ...
    fallback: `
      <main>
        <h1>Сказка по фото: ваш ребёнок — главный герой</h1>
        <p>Можно создать сказку по фото и получить сказку по фотографии ребёнка с узнаваемыми иллюстрациями.</p>
        <p>Это персональная сказка с фото: книга-сказка с иллюстрациями по фото, где ребёнок становится главным героем.</p>
        <p>Fairyteller делает не PDF, а печатную книгу от 3500₽ с редактурой и доставкой по России.</p>
        <ol>
          <li>загрузи фото</li>
          <li>получи превью</li>
          <li>закажи книгу</li>
        </ol>
        <p>Если нужна сказка где ребёнок главный герой, можно именная книга с фото заказать прямо на этой странице.</p>
