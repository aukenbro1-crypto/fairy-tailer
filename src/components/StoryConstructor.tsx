...
export const WORLDS = [{
  ...
  title: 'Приключения',
  description: 'Дорога, загадки и неожиданные помощники: герои отправляются в путешествие, полное неожиданных поворотов и загадочной развязки в конце.',
  tagline: '— Лови момент!'
}, {
  ...
  title: 'Мир Хогвартса',
  description: 'Герои оказываются в мире магии и волшебства, где можно раскрыть тайну, совершить сложный выбор или погрузиться в атмосферу любимого мира.',
  tagline: '— Алахамор-ра!'
}, {
  value: 'fantasy_epic',
  emoji: '🧙🏻‍♂️',
  ...
  title: 'Фэнтези',
  description: 'Мир, полный магии и чудес, ищет своих героев: им предстоит столкнуться с древним злом и победить его с помощью друзей, храбрости и отваги.',
  ...
  description: 'Будущее с панельками и летающими УАЗами, где технологии и корпорации победили всех остальных. Станьте героем киберприключения: взламывайте код, путешествуйте по неоновому городу и ищите ответы на сложные вопросы.',
