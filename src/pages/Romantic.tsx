...
Это лучший подарок на 14 февраля<br />
...
созданная специально про вас<br className="hidden md:block" />
      ...
      <AnimatedSection className="romantic-section-light py-16 md:py-20 px-6">
        <div className="max-w-2xl mx-auto">
          <h2 className="romantic-h2 text-2xl md:text-3xl mb-6">14 февраля — важный повод сделать интересный подарок своему партнеру</h2>
      ...
      <AnimatedSection id="romantic-how-it-works" className="romantic-section-light py-16 md:py-20 px-6">
        <div className="max-w-3xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            num: "2",
            text: "История и иллюстрации создаются"
          }, {
            num: "3",
