    ...
    <div className="min-h-screen bg-gradient-to-br from-[#A85844] via-[#C9968A] to-[#E8D9C3] font-serif">
      ...
      <header className="sticky top-0 z-50 bg-[#B8664F]/90 backdrop-blur-sm border-b-0 shadow-sm">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center">
            <img src={logoImage} alt="FairyTeller" className="h-20 md:h-24 w-auto max-w-md object-contain" />
          </div>
          <Link to="/create">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[1, 2, 3].map((i) => (
            <Card key={i} className="overflow-hidden bg-white/95 shadow-lg hover:shadow-xl transition-all duration-500 border-0 rounded-2xl">
