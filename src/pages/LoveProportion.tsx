...
export default function LoveProportion() {
  ...
  function handleWantsLove(choice: boolean) {
    ...
    if (choice) {
      ...
      goStep(6, "Я целился… но чихнул. Стрела ушла в небо. Тогда скажи: чем занимаешься?");
    }
  }
...
.lp-ok-btn:disabled { opacity: 0.3; cursor: default; }
.lp-ok-btn--full {
  width: 100%;
  margin-top: 16px;
  height: 44px;
...
.lp-copy-btn:hover { opacity: 0.82; }
.lp-again-link {
  background: none;
  border: none;
  font-size: 13px;
