...
const worlds = [
  ...
  },
  {
    ...
    title: "Приключения",
    text: "Дорога, загадки и неожиданные помощники: герои отправляются в путешествие, полное неожиданных поворотов и загадочной развязки в конце.",
    detail: "приключения",
  },
  {
    id: "hogwarts",
    ...
    title: "Мир Хогвартса",
    text: "Герои оказываются в мире магии и волшебства, где можно раскрыть тайну, совершить сложный выбор или погрузиться в атмосферу любимого мира.",
  ...
  },
  {
    ...
    value: "fantasy_epic",
    title: "Фэнтези",
    text: "Мир, полный магии и чудес, ищет своих героев: им предстоит столкнуться с древним злом и победить его с помощью друзей, храбрости и отваги.",
    detail: "фэнтези",
  },
  {
    id: "cyber",
    ...
    text: "Будущее с панельками и летающими УАЗами, где технологии и корпорации победили всех остальных. Станьте героем киберприключения: взламывайте код, путешествуйте по неоновому городу и ищите ответы на сложные вопросы.",
