...
import momPoletOpenHandsImage from "@/assets/landing-photos/wife-polet-open-hands.webp";
import momPoletBookshelfImage from "@/assets/landing-photos/wife-polet-bookshelf.webp";
import momPoletBackCoverImage from "@/assets/landing-photos/wife-polet-back-cover.webp";
import momZvezdopadClosedBookImage from "@/assets/landing-photos/wife-zvezdopad-closed-book.webp";
import momZvezdopadOpenTableImage from "@/assets/landing-photos/wife-zvezdopad-open-table.webp";
import momZvezdopadWideHeroImage from "@/assets/landing-photos/wife-zvezdopad-wide-hero.webp";
...
const process = [
  ...
  },
  {
    ...
    text: "Мягкий переплет, качественная печать, доставка по России от 2 дней. Можно заказать заранее или успеть к дате.",
  },
];

const momHeroSlots = ["Мама", "Вы", "Герой 3", "Герой 4"];

const heroImages = [
  { title: "Открытый разворот персональной книги маме", image: momPoletOpenHandsImage },
  { title: "Книга Полет над древом на полке", image: momPoletBookshelfImage },
  { title: "Задняя обложка персональной книги о семье", image: momPoletBackCoverImage },
];

const exampleImages = [
  { title: "Обложка книги Звездопад над Волгой в руках", image: momZvezdopadClosedBookImage },
  { title: "Открытый разворот персональной книги на столе", image: momZvezdopadOpenTableImage },
  { title: "Персональная книга Звездопад над Волгой в интерьере", image: momZvezdopadWideHeroImage },
];

const faqs = [
  {
    question: "Это подойдет как подарок маме на день рождения?",
    answer:
      "Да. Страница собрана именно под подарок маме на день рождения: книга получается личной, с ее именем, характером, фото и деталями вашей жизни вместе.",
  },
  {
    question: "Можно сделать книгу только про нее?",
    answer:
      "Да. Мама может быть главной героиней, а муж, семья, город, путешествие или важное воспоминание станут частью сюжета.",
  },
  {
...
const jsonLd = [
  {
    ...
    "@type": "Product",
    name: "Подарок маме на день рождения — книга о ней",
    description:
      "Персональная книга маме на день рождения: она главная героиня, сюжет про нее, иллюстрации по фото. От 3500₽, доставка по России от 2 дней.",
    ...
    offers: {
      ...
      url: "https://fairyteller.ru/podarok/mame",
    },
  },
  {
    "@context": "https://schema.org",
  ...
  },
  {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Подарок маме",
        item: "https://fairyteller.ru/podarok/mame",
      },
    ],
  },
];

const MomGiftLanding = () => {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-white text-black" style={typeStyle}>
      <SEO
        ...
        description="Персональная книга маме на день рождения: она главная героиня, сюжет про неё, иллюстрации по фото. От 3500₽, доставка по России от 2 дней."
        path="/podarok/mame"
      ...
      <style>
        {`
          ...
          .mom-page .fairyteller-choice-strip {
            overscroll-behavior-x: contain;
            scrollbar-width: none;
          }

          .mom-page .fairyteller-choice-strip::-webkit-scrollbar {
            display: none;
          }
        `}
      </style>
      ...
      <div className="mom-page">
          ...
          <div className="flex min-w-0 flex-col justify-between border-black px-5 py-9 md:px-8 md:py-11 lg:border-r lg:pb-16">
            <div className="w-full max-w-[340px] md:max-w-none">
              ...
              <h1 className="mt-5 w-full max-w-full break-normal text-[25px] font-black uppercase leading-[1.08] tracking-normal min-[420px]:text-[29px] sm:text-[33px] md:max-w-[780px] md:text-[34px] lg:text-[34px] 2xl:text-[42px]">
                Подарок маме на день рождения: книга, в которой она главная героиня
              </h1>
              <p className="mt-5 w-full max-w-[340px] text-[16px] leading-[1.42] md:max-w-[680px] md:text-[21px] md:leading-[1.35]">
                Персональная книга с ее именем, характером и историей жизни - такой подарок существует только в одном экземпляре. От 3500₽.
              </p>
          ...
          <div className="min-w-0 overflow-hidden bg-[#f5f5f5]">
            <div className="relative flex h-full min-h-[420px] items-center justify-center md:min-h-[560px] lg:min-h-0">
              <button
                ...
                aria-label="Показать следующее фото книги маме"
              >
        ...
        <section id="meaning" className="scroll-mt-24 border-y border-black bg-[#fae7e1] px-5 py-9 md:px-8 md:py-11">
          <div className="mx-auto grid max-w-[1480px] gap-10 lg:grid-cols-[0.78fr_1.22fr]">
            <div>
              <h2 className={sectionTitleClass}>Не очередной сувенир</h2>
            </div>
            <div className="grid border-l border-t border-black md:grid-cols-2">
              <article className="border-b border-r border-black bg-white p-5">
                ...
                <p className="mt-5 text-[16px] leading-7 text-[#5e6264]">
                  Хороший подарок говорит что-то о человеке которому предназначен.
                </p>
              </article>
              <article className="border-b border-r border-black bg-white p-5">
                ...
                <p className="mt-5 text-[16px] leading-7 text-[#5e6264]">
                  Книга о маме - это история написанная под нее одну. С ее именем, ее характером, деталями которые знаете только вы. Такое не покупают в магазине.
                </p>
              </article>
            </div>
          </div>
        ...
        <section id="create" className="scroll-mt-24 border-b border-black bg-[#fae7e1] px-5 py-9 md:px-8 md:py-11">
          <FairytellerInlineConstructor
            ...
            submitLabel="Создать книгу маме"
          />
        </section>
          ...
          <div className="mx-auto max-w-[1480px]">
            <div className="mb-9 grid gap-5 md:grid-cols-[1fr_440px] md:items-end">
              ...
              <p className="text-[18px] leading-7 text-[#5e6264]">
                40 страниц, 5 глав - полноценная история, не открытка. Каждая глава - отдельный поворот сюжета: знакомство с героиней, испытание, выбор, кульминация, финал. Иллюстрации поддерживают ключевые сцены. Перед печатью текст читает редактор, чтобы история читалась как книга, а не как сгенерированный текст.
              </p>
            </div>
