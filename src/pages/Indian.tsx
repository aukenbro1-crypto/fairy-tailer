          ...
          <div className="space-y-2 md:space-y-3">
            <Accordion type="single" collapsible className="w-full">
              ...
              >
                ...
                <AccordionContent className="text-amber-900/90 text-sm md:text-base px-4 md:px-6 pb-4">
                  Сначала вы получаете PDF на почту в течение 10–20 минут. Если вам нравится результат, вы оплачиваете заказ. Срок изготовления книги — 1 день, наша типография располагается в Москве. Сроки доставки зависят от города. Список популярных направлений доставки и сроков смотрите <a href="/delivery/" className="underline hover:text-amber-800">здесь</a>.
                </AccordionContent>
              </AccordionItem>
